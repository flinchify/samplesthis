...
export default function Footer() {
  return (
    <footer className="border-t border-black/[0.04] bg-[var(--bg-2)]">
      <div className="max-w-[1200px] mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          <div>
            <div className="w-9 h-9 rounded-[12px] grad-warm-bg flex items-center justify-center shadow-lg shadow-orange-500/10 mb-5">
            ...
            <p className="text-[12px] text-[var(--text-dim)] leading-[1.8]">Find the flinch before<br />your users do.</p>
          </div>
          {COLS.map((col) => (
            <div key={col.title}>
              <p className="h text-[10px] font-bold text-[var(--text-dim)] uppercase tracking-[0.2em] mb-5">{col.title}</p>
        ...
        <div className="border-t border-black/[0.04] pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
