...
const COLS = [
  { title: "For experts", links: [{ href: "/become-a-tester", label: "Find work" }, { href: "/how-it-works#testers", label: "How it works" }] },
  { title: "For businesses", links: [{ href: "/submit", label: "Post a test" }, { href: "/pricing", label: "Pricing" }, { href: "/how-it-works", label: "How it works" }] },
  { title: "Contact us", links: [{ href: "/contact", label: "Support" }, { href: "/about", label: "About" }] },
  { title: "Flinchify", links: [{ href: "/privacy", label: "Privacy" }, { href: "/terms", label: "Terms" }] },
];
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-14">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <Image src="/logo.png" alt="Flinchify" width={32} height={32} className="mb-4" />
          </div>
          {COLS.map((col) => (
            <div key={col.title}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 pt-6 border-t border-black/[0.04]">
          <p className="text-[12px] text-[var(--text-dim)]">&copy; 2026 Flinchify</p>
