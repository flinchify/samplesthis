    ...
    <>
      ...
      <main className="pt-16 min-h-screen">
        <div className="max-w-2xl mx-auto px-5 py-16 md:py-24">
          <h1 className="text-3xl md:text-[3rem] font-bold tracking-tight mb-6">About ShipTest</h1>
          ...
          <div className="space-y-6 text-[15px] text-[var(--text-muted)] leading-relaxed">
            ...
            <p>
              ShipTest exists to close that gap. Submit your URL, describe who your app is for, and get real humans — matched to your target audience — testing it within hours. Screen recordings, bug reports, honest feedback. No subscription, no minimum spend.
            </p>
            <p>
