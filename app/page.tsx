  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ═══ STATS ═══ */}
        <section className="bg-[var(--bg-2)] pb-20 pt-4 px-6">
          <div className="max-w-[900px] mx-auto -mt-12 relative z-20">
            <div className="bg-white rounded-2xl border border-black/[0.06] shadow-xl shadow-black/[0.03] p-1">
              <div className="grid grid-cols-2 md:grid-cols-4">
                {[
                  ...
                  <div key={s.label} className={`text-center py-7 px-4 ${i < 3 ? "border-r border-black/[0.04]" : ""}`}>
                    <p className="h text-2xl md:text-3xl font-bold grad-warm">{s.value}</p>
                    <p className="text-[11px] text-[var(--text-dim)] mt-1 uppercase tracking-wider">{s.label}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* ═══ TOOL MARQUEE ═══ */}
        <section className="bg-[var(--bg-2)] py-10 overflow-hidden">
          ...
          <div className="flex items-center marquee whitespace-nowrap">
            {[...Array(2)].flatMap(() =>
              ["Cursor", "Bolt", "Replit", "Lovable", "v0", "Windsurf", "Claude", "ChatGPT", "Vercel", "Supabase", "Next.js", "React"].map((t, i) => (
                <span key={`${t}-${i}`} className="mx-10 h text-[13px] font-semibold text-black/[0.06] uppercase tracking-[0.15em]">{t}</span>
              ))
            )}
          </div>
        </section>
            ...
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <h2 className="h text-3xl md:text-[3.2rem] font-bold tracking-[-0.03em] leading-tight">
                  One platform.<br /><span className="text-[var(--text-dim)]">Two ways to win.</span>
                </h2>
              </div>
            </ScrollReveal>
              ...
              <ScrollReveal delay={100}>
                <div className="glow-card h-full">
                  <Link href="/submit" className="glow-card-inner block p-8 md:p-10 group">
                    <div className="w-14 h-14 rounded-2xl grad-warm-subtle border border-orange-500/10 flex items-center justify-center mb-7 group-hover:border-orange-500/20 transition-all duration-300">
                      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#F97316" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-70">
                    ...
                    <span className="inline-flex items-center gap-2 h text-[13px] font-semibold text-[var(--text-dim)] group-hover:text-orange-500 transition-colors duration-300">
                      Post a test job
                  ...
                  <div className="job-card flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-6 shrink-0">
                      <div className="text-center">
                        ...
                        <p className="text-[9px] text-[var(--text-dim)] uppercase tracking-widest mt-0.5">per tester</p>
                      </div>
                      <div className="w-px h-8 bg-black/[0.04]" />
                      <div className="text-center">
                        <p className="h text-[17px] font-bold text-[var(--text)]">{job.testers}</p>
                        <p className="text-[9px] text-[var(--text-dim)] uppercase tracking-widest mt-0.5">needed</p>
                      </div>
                      <div className="w-px h-8 bg-black/[0.04]" />
                      <div className="text-center">
                        <p className="h text-[17px] font-bold text-[var(--text-muted)]">{job.applied}</p>
                        <p className="text-[9px] text-[var(--text-dim)] uppercase tracking-widest mt-0.5">applied</p>
                      </div>
                    </div>
                  </div>
                </ScrollReveal>
        ...
        <section className="py-24 md:py-32 px-6">
          <div className="max-w-[1000px] mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-16 md:gap-24">
              <div>
                <ScrollReveal><p className="h text-[11px] font-bold text-orange-500/70 uppercase tracking-[0.25em] mb-8">For businesses</p></ScrollReveal>
                {[
                  ...
                  <ScrollReveal key={s.n} delay={i * 100}>
                    <div className="flex gap-5 mb-7">
                      <div className="w-10 h-10 rounded-xl grad-warm-subtle border border-orange-500/8 flex items-center justify-center shrink-0">
                        <span className="h text-[11px] font-bold text-orange-500/60">{s.n}</span>
                      </div>
              ...
              <div>
                <ScrollReveal><p className="h text-[11px] font-bold text-red-500/60 uppercase tracking-[0.25em] mb-8">For testers</p></ScrollReveal>
                {[
                  ...
                  <ScrollReveal key={s.n} delay={i * 100}>
                    <div className="flex gap-5 mb-7">
                      <div className="w-10 h-10 rounded-xl bg-red-50 border border-red-500/8 flex items-center justify-center shrink-0">
                        <span className="h text-[11px] font-bold text-red-500/50">{s.n}</span>
                      </div>
                      <div className="pt-0.5">
                        <h4 className="h text-[15px] font-semibold mb-1 text-[var(--text)]">{s.t}</h4>
                        <p className="text-[13px] text-[var(--text-muted)] leading-relaxed">{s.d}</p>
              ...
              {[
                ...
                <ScrollReveal key={d.title} delay={i * 80}>
                  <div className="card-light p-6 h-full">
                    <div className="w-11 h-11 rounded-xl grad-warm-subtle border border-orange-500/8 flex items-center justify-center mb-5">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F97316" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-60"><path d={d.icon} /></svg>
                    </div>
        ...
        <section className="dark-section py-24 md:py-32 px-6">
          <div className="max-w-[900px] mx-auto text-center">
            <ScrollReveal>
              ...
              <p className="text-[15px] text-white/40 mb-14 max-w-md mx-auto leading-relaxed">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              {[
                ...
                <ScrollReveal key={t.label} delay={i * 100}>
                  <div className={`rounded-2xl border p-7 text-center transition-all duration-400 ${t.pop ? "border-orange-500/20 bg-white/[0.04]" : "border-white/[0.06] bg-white/[0.02]"}`}>
                    ...
                    <p className="h text-[10px] font-bold text-white/25 uppercase tracking-[0.2em] mb-2">{t.label}</p>
                    <p className="h text-3xl md:text-4xl font-bold grad-warm mb-1">{t.range}</p>
                    <p className="h text-[12px] font-semibold text-orange-400/70 mb-3">{t.speed}</p>
        ...
        <section className="relative py-32 px-6 overflow-hidden bg-white">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-b from-orange-500/[0.04] to-transparent rounded-full blur-[80px]" />
