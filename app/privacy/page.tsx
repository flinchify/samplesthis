        ...
        <div className="max-w-2xl mx-auto px-5 py-16 md:py-24">
          ...
          <div className="space-y-8 text-[14px] text-[var(--text-muted)] leading-relaxed">
            ...
            <section>
              ...
              <p>Under the Australian Privacy Act 1988 and applicable privacy principles, you have the right to access, correct, or delete your personal information. Contact us at privacy@Flinchify.dev.</p>
            </section>
            ...
            <section>
              ...
              <p>For privacy inquiries: privacy@Flinchify.dev</p>
            </section>
          </div>
        </div>
      </main>
